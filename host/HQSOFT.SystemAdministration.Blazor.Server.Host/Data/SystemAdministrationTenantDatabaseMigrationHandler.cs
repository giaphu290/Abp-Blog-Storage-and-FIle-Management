...
using HQSOFT.SystemAdministration.Blazor.Server.Host.EntityFrameworkCore;
...
namespace HQSOFT.SystemAdministration.Data;

public class SystemAdministrationTenantDatabaseMigrationHandler :
    IDistributedEventHandler<TenantCreatedEto>,
    IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
    IDistributedEventHandler<ApplyDatabaseMigrationsEto>,
    ITransientDependency
{
    private readonly IDbContextProvider<UnifiedDbContext> _dbContextProvider;
    private readonly ICurrentTenant _currentTenant;
    private readonly IUnitOfWorkManager _unitOfWorkManager;
    private readonly IDataSeeder _dataSeeder;
    private readonly ITenantStore _tenantStore;
    private readonly ILogger<SystemAdministrationTenantDatabaseMigrationHandler> _logger;

    public SystemAdministrationTenantDatabaseMigrationHandler(
        IDbContextProvider<UnifiedDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<SystemAdministrationTenantDatabaseMigrationHandler> logger)
    {
