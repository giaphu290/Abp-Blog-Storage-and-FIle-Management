...
using HQSOFT.SystemAdministration.Blazor.WebAssembly;
...
[DependsOn(
    ...
    typeof(SystemAdministrationBlazorWebAssemblyModule)
)]
public class SystemAdministrationBlazorHostClientModule : AbpModule
{
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(SystemAdministrationBlazorHostClientModule).Assembly;
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new SystemAdministrationHostMenuContributor(context.Services.GetConfiguration()));
        });
    }
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add("Module");
        });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<SystemAdministrationBlazorHostClientModule>();
        });
    }
}
