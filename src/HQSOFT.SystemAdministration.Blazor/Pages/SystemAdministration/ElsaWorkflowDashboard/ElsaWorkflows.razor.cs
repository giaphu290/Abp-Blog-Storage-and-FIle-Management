...
namespace HQSOFT.SystemAdministration.Blazor.Pages.SystemAdministration.ElsaWorkflowDashboard
{
    public partial class ElsaWorkflows
    {
        ...
        string ElsaUrl { get; set; } = string.Empty;


        private HQSOFTBreadcrumbScreen BreadcrumbScreen = new HQSOFTBreadcrumbScreen();
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            if (firstRender && !_scriptsLoaded)
            {
                ...
                await JSRuntime.InvokeVoidAsync("registerElsaUtilsBlazorMethod", DotNetObjectReference.Create(this)); 
                await JSRuntime.InvokeVoidAsync("onElsaLoaded");
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            await GetElsaWorkflowsDashboardAsync();
        ...
        async Task GetElsaWorkflowsDashboardAsync()
        {
        ...
        [JSInvokable]
        public async Task ResetElsaToolbarItemsAsync()
        {
